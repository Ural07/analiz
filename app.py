...
def load_data_from_s3():
    ...
    with DATA_LOCK: 
        ...
        if not DB_FILE_URL:
            print("HATA: DB_FILE_URL ayarlanmamış, veri çekilemiyor.")
            return False
            
        try:
            # 1. Adım: Dosyayı S3'ten İndir
